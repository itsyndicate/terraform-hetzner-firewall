...
| <a name="input_ssh_port"></a> [ssh\_port](#input\_ssh\_port) | TCP port the incoming SSH rule opens | `number` | `22` | no |
...
| Name | Description |
| ---- | ----------- |
| <a name="output_firewall_id"></a> [firewall\_id](#output\_firewall\_id) | ID of the Firewall resource |
<!-- END_TF_DOCS -->